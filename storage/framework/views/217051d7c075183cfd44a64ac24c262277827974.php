        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="<?php echo e(route('admin.post.store')); ?>" method="POST" enctype="multipart/form-data" class="w-full">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center border-b border-gray-400 border-teal-500 mb-4 py-2">
                          <input class="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Post name" aria-label="Post name..." name="title" value="<?php echo e(old('title')); ?>">
                        </div>
                        ...
                        <label class="block text-left" style="max-width: 300px">
                            ...
                            <select class="form-multiselect block w-full mt-1" name="category_id[]" multiple>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option <?php echo e(is_array( old('category_id')) && in_array($category->id, old('category_id')) ? ' selected' : ''); ?> value="<?php echo e($category->id); ?>"><?php echo e($category->title); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <textarea name="content" id="ckeditor" rows="10" cols="80"><?php echo e(old('content')); ?></textarea>
...
<?php endif; ?>
<?php /**PATH /var/www/blog/resources/views/admin/post/create.blade.php ENDPATH**/ ?>