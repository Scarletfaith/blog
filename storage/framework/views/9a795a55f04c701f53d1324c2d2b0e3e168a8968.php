                    ...
                    <table class="table-fixed mb-4 w-full bg-gray-50">
                        <tbody class="bg-white">
                            ...
                            <tr class="whitespace-nowrap">
                                ...
                                <td class="border border-gray-400 px-6 py-4 text-sm text-gray-500"><?php echo e($post->created_at->format('d-m-Y, H:i:s')); ?></td>
                            </tr>
                            <tr class="whitespace-nowrap">
                                ...
                                <td class="border border-gray-400 px-6 py-4 text-sm text-gray-500">
                                    <?php if($post->updated_at): ?>
                                        <?php echo e($post->updated_at->format('d-m-Y, H:i:s')); ?>
