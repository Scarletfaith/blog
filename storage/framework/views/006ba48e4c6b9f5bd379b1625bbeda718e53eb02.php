        ...
        <a class="no-underline transition block border border-lighter w-full mb-10 p-5 rounded post-card" href="<?php echo e(route('blog.show', $post->slug)); ?>">
            ...
            <div class="flex flex-col justify-between flex-1">
                ...
                <div class="flex items-center text-sm text-light">
                    ...
                    <span class="ml-auto"><?php echo e($post->updated_at->format('M, j Y')); ?></span>
                </div>
            </div>
        </a>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/blog/resources/views/blog/index.blade.php ENDPATH**/ ?>